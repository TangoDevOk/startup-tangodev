...
export default function InfiniteScroll({
  ...
  return (
    <div
      ...
      ref={wrapperRef}
      style={{ maxHeight, backgroundColor: 'transparent' }}
    >
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center text-lg font-medium text-center text-stone-200 select-none box-border relative overflow-hidden"
            key={i}
            style={{
